...
rule confirm_sexing:
    ...
    output:
        ...
        gencov_het_small = report(outdir + "output/synteny/" + synteny_abbr + "/plots/" + "confirm_sexing_indv.{ED}.small.pdf", category="2. Confirm sexing", caption="../report/confirm_sexing.rst"),
    threads: 1
    params:
