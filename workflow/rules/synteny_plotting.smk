...
rule plotting:
    ...
    output:
        touch(outdir + "output/synteny/" + synteny_abbr + "/tables/" + "plotting.{bp}bp.done")
    params:
...
rule plotting_linear:
    input:
        ...
        snp = outdir + "output/synteny/" + synteny_abbr + "/tables/" + "diffHeterozygosity.{bp}bp.out"
    output:
        touch(outdir + "output/synteny/" + synteny_abbr + "/plots/plotting.linear.{bp}bp.done")
    params:
...
rule plotting_chr:
    ...
    output:
        touch(outdir + "output/synteny/" + synteny_abbr + "/plots/plotting_chr.done")
    params:
